                ...
                {state && (
                    ...
                    >
                        ...
                        >
                            ...
                            <m.li custom={0} variants={listItemVaraints}>
                                <Link href="/">Home</Link>
                            </m.li>
                            <m.li custom={1} variants={listItemVaraints}>
                                <Link href="/our-story">Our Story</Link>
                            </m.li>
                            <m.li custom={2} variants={listItemVaraints}>
                                <Link href="/about">About</Link>
                            </m.li>
                            <m.li custom={3} variants={listItemVaraints}>
                                <Link href="/faqs">FAQs</Link>
                            </m.li>
                            <m.li custom={4} variants={listItemVaraints}>
                                <Link href="/contact">Contact</Link>
                            </m.li>
                            <m.li custom={5} variants={listItemVaraints}>
                                <div>
                                    <Button
                                        onClick={openModal}
                                        size="large"
                            ...
                            <m.li custom={6} variants={listItemVaraints}>
